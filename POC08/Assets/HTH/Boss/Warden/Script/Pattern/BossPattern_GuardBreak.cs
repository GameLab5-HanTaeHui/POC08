...
namespace SEAL
{
    ...
    public class BossPattern_GuardBreak : BossPatternBase
    {
        ...
        private BossWardenPatternDataSO.GuardBreakSettings GuardBreakData
            => _data != null && _data.PatternData != null
                ? _data.PatternData.GuardBreak
                : BossWardenPatternDataSO.DefaultGuardBreak;
        ...
        {
            ConfigureLifecycle(GuardBreakData.lifecycle, CommonData);
            _triggerGroggyOnRecovery = true;
        }
        ...
        protected override IEnumerator OnWarning()
        {
            ...
            var pattern = GuardBreakData;
            float guardDuration = pattern.GetGuardDuration(_isPhase2);
            ...
            Vector3 guardOffset = localFacingDir.normalized * pattern.guardForwardAmount;
            Vector3 backswingOff = -localFacingDir.normalized * pattern.windupPullAmount;
            _thrustLocalOff = localFacingDir.normalized * pattern.thrustDistance;
            ...
            Vector2 warningSize = pattern.GetWarningSize(_isPhase2);
        ...
        protected override IEnumerator OnActive()
        {
            ...
            {
                _armRTransform
                    .DOLocalMove(_armROriginLocalPos + _thrustLocalOff, pattern.thrustDuration)
                    .SetEase(Ease.OutExpo);
            }

            yield return new WaitForSecondsRealtime(pattern.thrustDuration);
            if (_isInterrupted) yield break;
            ...
            Vector2 boxSize = pattern.GetHitboxSize(_isPhase2);
